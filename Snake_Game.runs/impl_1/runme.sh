...
HD_PWD='C:/Users/griff/Documents/Classes/ECE 480/P2/part2/part2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Snake_part2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Snake_part2.tcl -notrace
