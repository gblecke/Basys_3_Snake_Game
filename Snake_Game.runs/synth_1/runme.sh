...
HD_PWD='C:/Users/griff/Documents/Classes/ECE 480/P2/part2/part2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Snake_part2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Snake_part2.tcl
